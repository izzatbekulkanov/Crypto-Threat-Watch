...
TEXTS: dict[str, dict[str, str]] = {
    ...
    "help": {
        "uz": (
            ...
            "ℹ️ _Bot bilan ishlash uchun pastdagi tugmalardan foydalanishingiz mumkin._"
        ),
        "ru": (
            ...
            "ℹ️ _Для работы с ботом вы можете использовать кнопки ниже._"
        ),
        "en": (
            ...
            "ℹ️ _You can use the menu buttons below to interact with the bot._"
        ),
    },
